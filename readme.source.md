...
<div style={{
  ...
  <div style={{
    ...
    <img src={github?.user?.avatarUrl ?? 'https://github.com/jeanpatrickm.png'} width={88} height={88} style={{ borderRadius: 44 }} />
  </div>

  <div style={{ display:'flex', flexDirection:'column', marginLeft:168, gap:8, zIndex: 10 }}>
    <div style={{ display:'flex', fontSize:38, fontWeight:800, color:'#ffffff', letterSpacing:'-1px', lineHeight:1 }}>
      {github?.user?.name || github?.user?.login || 'jeanpatrickm' || 'Name'}
    </div>
